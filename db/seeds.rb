...
quiz1 = File.open("public/quiz_template/quiz-html.html", 'rb') {|io| io.read }


base_uri = "https://viciousunicorn.firebaseio.com/Sagas"
firebase = Firebase::Client.new(base_uri)

firebase.push(base_uri, {"Volume 1" => {"Contents" => {"Chapter 1"=>{"Scene 1"=>"eKhan was impressed by my coolness", "Scene 2" => quiz1, "Scene 3"=>"asdfasdfasdf"}}}})
